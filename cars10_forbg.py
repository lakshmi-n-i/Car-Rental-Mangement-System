...
def filters():
    ...
    cb1= Checkbutton(screen4,text="Pick-up Location",command=showfilter, variable=var1,font=('Calibri',14,'bold'))
    cb1.place(relx=0.03, rely=0.22)
    cb2= Checkbutton(screen4,text="With/Without Driver", command=showfilter,variable=var2,font=('Calibri',14,'bold'))
    cb2.place(relx=0.03, rely=0.32)
    cb3= Checkbutton(screen4,text="Price Range", command=showfilter,variable=var3,font=('Calibri',14,'bold'))
    cb3.place(relx=0.03, rely=0.42)
    cb4= Checkbutton(screen4,text="Seater Capacity", command=showfilter,variable=var4,font=('Calibri',14,'bold'))
    cb4.place(relx=0.03, rely=0.52)
...
def driver():
    ...
    bgimage = PhotoImage(file=r"C:\Users\user\Downloads\mountain.png")
    lb20= Label(screen6, image=bgimage).pack()
