...
def screen1():
    ...
    bg=PhotoImage(file=r"C:\Users\user\Desktop\PES\FirstSem\Python_Project\bg_images\image2.png")
...
def filters():
    ...
    bg2=PhotoImage(file=r"C:\Users\user\Desktop\PES\FirstSem\Python_Project\bg_images\image8.png")
    ...
    btn11= Button(screen4, text= "Try another filter",command=deselection, font=('Calibri',15)).place(relx=0.81,rely=0.65)
    screen4.mainloop()
...
def pickup():
    ...
    bg3=PhotoImage(file=r"C:\Users\user\Desktop\PES\FirstSem\Python_Project\bg_images\image9.png")
...
def driver():
    ...
    bg4=PhotoImage(file=r"C:\Users\user\Desktop\PES\FirstSem\Python_Project\bg_images\image9.png")
...
def price():
    ...
    bg5=PhotoImage(file=r"C:\Users\user\Desktop\PES\FirstSem\Python_Project\bg_images\image9.png")
...
def seater():
    ...
    bg6=PhotoImage(file=r"C:\Users\user\Desktop\PES\FirstSem\Python_Project\bg_images\image9.png")
...
def returns():
    ...
    bg1=PhotoImage(file=r"C:\Users\user\Desktop\PES\FirstSem\Python_Project\bg_images\image10.png")
